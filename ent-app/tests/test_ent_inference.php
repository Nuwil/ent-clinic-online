...
$hnl0 = $d0['data']['hnlmo_distribution'] ?? $d0['hnlmo_distribution'] ?? null;
if (!$hnl0) { echo "FAILED: Cannot read hnlmo_distribution (baseline)\n"; exit(1); }
$labels0 = $hnl0['labels']; $data0 = $hnl0['data'];
...
$hnl1 = $d1['data']['hnlmo_distribution'] ?? $d1['hnlmo_distribution'] ?? null;
if (!$hnl1) { echo "FAILED: Cannot read hnlmo_distribution (after)\n"; exit(1); }
$labels1 = $hnl1['labels']; $data1 = $hnl1['data'];
